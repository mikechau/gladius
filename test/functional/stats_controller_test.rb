...
class StatsControllerTest < ActionController::TestCase
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post :create, stat: { cha: @stat.cha, con: @stat.con, dex: @stat.dex, intel: @stat.intel, str: @stat.str, user_id: @stat.user_id, wis: @stat.wis }
    end
  ...
  test "should update stat" do
    put :update, id: @stat, stat: { cha: @stat.cha, con: @stat.con, dex: @stat.dex, intel: @stat.intel, str: @stat.str, user_id: @stat.user_id, wis: @stat.wis }
    assert_redirected_to stat_path(assigns(:stat))
  end
